(() => {
  ...
  const PRIORITIES = [
    "Staying in our home and on our 13 acres",
    "Freeing David from his current W2 job",
    "Growing the Twisted Creek LLC ventures",
    "Maxing out 401(k) retirement contributions",
    "Wiping out non-mortgage debt",
    "Paying off the mortgage early",
    "Building deep cash reserves for the unexpected",
    "Investing excess cash for market growth"
  ];
  ...
  sendBtn.addEventListener("click", () => {
    ...
    formData.append("_subject", `Priority Results: ${userName} Chitwood`);
    formData.append("message", `Priority ranking for ${userName} Chitwood:\n\n${body}`);
